...
def barPlot():
    ...
    st.bar_chart(df_indonesia['Q25'].value_counts().reindex(['0-999', '1000-1999', '2000-2999', '3000-3999','4000-4999','5000-7499', '7500-9999','10000-14999','15,000-19,999','20,000-24,999','25,000-29,999','30,000-39,999', '40,000-49,999','50,000-59,999','60,000-69,999','70,000-79,999','80,000-89,999', '90,000-99,999','100,000-124,999','125,000-149,999','150,000-199,999','200,000-249,999','250,000-299,999', '300,000-499,999','500,000-999,999','>1,000,000']))
barPlot()
